...
class transferspecify(tk.Frame):
      def __init__(self, master):
             ...
             self.button13.grid(row=3,column=1,sticky='W',padx=30,pady=20)
...
class edit(tk.Frame):
              def __init__(self, master):
                    ...
                    self.e5=ttk.Entry(self,font=("Times 18 italic"))
                    self.e5.grid(row=5,column=2,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e6=ttk.Entry(self,font=("Times 18 italic"))
                    self.e6.grid(row=6,column=2,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e8=ttk.Entry(self,font=("Times 18 italic"))
                    self.e8.grid(row=8,column=2,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e9=ttk.Entry(self,font=("Times 18 italic"))
                    self.e9.grid(row=9,column=2,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e11=ttk.Entry(self,font=("Times 18 italic"))
                    self.e11.grid(row=11,column=2,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e12=ttk.Entry(self,font=("Times 18 italic"))
                    self.e12.grid(row=12,column=2,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e16=ttk.Entry(self,font=("Times 18 italic"))
                    self.e16.grid(row=4,column=6,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e17=ttk.Entry(self,font=("Times 18 italic"))
                    self.e17.grid(row=5,column=6,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.e21=ttk.Entry(self,font=("Times 18 italic"))
                    self.e21.grid(row=9,column=6,sticky='W',padx=35,pady=3,ipady=3)
                    ...
                    self.llla24.grid(row=13,column=4,sticky='W',pady=5,padx=35)
                    self.button19=ttk.Button(self,text="BACK",style = 'W.TButton',command=lambda: master.switch_frame(transferspecify))
                    self.button19.grid(row=13,column=6,sticky='W',padx=35,pady=3,ipady=3)
...
class newreg(tk.Frame):
              def __init__(self, master):
                ...
                self.e5=ttk.Entry(self,font=("Times 15 italic"))
                self.e5.grid(row=5,column=2,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e6=ttk.Entry(self,font=("Times 15 italic"))
                self.e6.grid(row=6,column=2,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e8=ttk.Entry(self,font=("Times 15 italic"))
                self.e8.grid(row=8,column=2,sticky='W',padx=40,pady=3,ipady=3)
                
                self.l9=ttk.Label(self,text="Sex",font=("Times 15 italic"),background="darkorchid")
                ...
                self.e9=ttk.Entry(self,font=("Times 15 italic"))
                self.e9.grid(row=9,column=2,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e11=ttk.Entry(self,font=("Times 15 italic"))
                self.e11.grid(row=11,column=2,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e12=ttk.Entry(self,font=("Times 15 italic"))
                self.e12.grid(row=1,column=6,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e16=ttk.Entry(self,font=("Times 15 italic"))
                self.e16.grid(row=5,column=6,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e17=ttk.Entry(self,font=("Times 15 italic"))
                self.e17.grid(row=6,column=6,sticky='W',padx=40,pady=3,ipady=3)
                ...
                self.e21=ttk.Entry(self,font=("Times 15 italic"))
                self.e21.grid(row=10,column=6,sticky='W',padx=40,pady=3,ipady=3)
            
                self.la22=ttk.Label(self,text="Cell Number",font=("Times 15 italic"),background="darkorchid")
