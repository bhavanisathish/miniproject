...
class edit(tk.Frame):
              def __init__(self, master):
                    ...
                    if(e):
                        ...
                        self.labe=ttk.Label(self.Frame1,text="EDIT",font=("Times 25 italic"),background='snow')
                        ...
                        self.e1=ttk.Entry(self.Frame4,font=("Times 14 italic"),width=21)
                        ...
                        self.e4=ttk.Entry(self.Frame4,font=("Times 14 italic"),width=21)
                        ...
                        self.p4 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e9)
                        self.p4['values']=(e[8],'Male','Female','Others')  
                        self.p4.grid(row=3,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p4.current(0)
                        ...
                        self.p2 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e6)
                        self.p2['values']=(e[5],'Hindu','Musim','Christian','Others')
                        self.p2.grid(row=5,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p2.current(0)
                        ...
                        self.e7=ttk.Entry(self.Frame4,font=("Times 14 italic"),width=21)
                        ...
                        self.p3 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e8)
                        self.p3['values']=(e[7],'OC','BC','BCM','MBC','SC','ST','Others')  
                        self.p3.grid(row=7,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p3.current(0)
                        ...
                        self.p7 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e16)
                        self.p7['values']=(e[15],'Tamil','Hindi','Telugu','Kannada','Malayalam','Sourashtra','Others')  
                        self.p7.grid(row=8,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p7.current(0)
                        ...
                        self.pp1 =ttk.Combobox(self.Frame5, width=21, textvariable=self.e5)
                        self.pp1['values']=(e[4],'Indian','Others')
                        self.pp1.grid(row=1,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.pp1.current(0)
                        ...
                        self.e18=ttk.Entry(self.Frame5,font=("Times 14 italic"),width=21)
                        ...
                        self.e19=ttk.Entry(self.Frame5,font=("Times 14 italic"),width=21)
                        ...
                        self.e20=ttk.Entry(self.Frame5,font=("Times 14 italic"),width=21)
                        ...
                        self.p9 =ttk.Combobox(self.Frame5, width=21, textvariable=self.e21)
                        ...
                        self.p9.grid(row=5,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p9.current(0)
                        ...
                        self.p8 =ttk.Combobox(self.Frame5, width=21, textvariable=self.e17)
                        ...
                        self.p8.grid(row=6,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p8.current(0)
                        ...
                        self.e10=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=21)
                        ...
                        self.ea23=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=21)
                        ...
                        self.ea22=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=21)
                        ...
                        self.e2=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=21)
                        ...
                        self.e3=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=21)
                        ...
                        self.p5 =ttk.Combobox(self.Frame7, width=21, textvariable=self.e11)
                        self.p5['values']=(e[10],'BE','ME','BE Parttime')  
                        self.p5.grid(row=6,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p5.current(0)
                        ...
                        self.p6 =ttk.Combobox(self.Frame7,width=21, textvariable=self.e12)
                        ...
                        self.p6.grid(row=7,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                        self.p6.current(0)
                        ...
                        self.e13=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=21)
                        ...
                        self.ll14.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e14=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=21)
                        ...
                        self.e15=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=21)
                        ...
                        self.ea25=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=21)
                        ...
                        self.ea24=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=21)
                        ...
                        self.button19=ttk.Button(self.Frame9,text="Back",style = 'W.TButton',command=lambda: master.switch_frame(editspecify))
...
class newreg(tk.Frame):
              def __init__(self, master):
                ...
                self.labe=ttk.Label(self.Frame1,text="INSERT RECORD",font=("Times 25 italic"),background='snow')
                self.labe.grid(row=0,column=0,sticky='W',pady=5,padx=35)
                ...
                self.p4 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t4)
                ...
                self.p2 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t2)
                ...
                self.p3 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t3)
                ...
                self.p7 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t7)
                ...
                self.pp1 =ttk.Combobox(self.Frame5, width=21, textvariable=self.t1)
                ...
                self.p9 =ttk.Combobox(self.Frame5, width=21, textvariable=self.t9)
                ...
                self.p8 =ttk.Combobox(self.Frame5, width=21, textvariable=self.t8)
                ...
                self.Frame7 = tk.Frame(self.Frame3)
                self.Frame7.pack(side="top",expand=True,ipadx=10)
                self.Frame7.configure(background='MistyRose3')
                ...
                self.p5 =ttk.Combobox(self.Frame7, width=21, textvariable=self.t5)
                ...
                self.ll12.grid(row=7,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t6 = tk.StringVar(self)
                self.p6 =ttk.Combobox(self.Frame7,width=21, textvariable=self.t6)
                self.p6['values']=('Civil Engineering','Mechanical Engineering','Electrical and Electronics Engineering','Electronics and Communication Engineering','Computer science and Engineering')  
                self.p6.grid(row=7,column=2,sticky='W',padx=20,pady=5,ipadx=33,ipady=5)
                self.p6.current()
                
                self.la26=ttk.Label(self.Frame7,text="Year Of Completion",font=("Times 14 italic"),background='MistyRose3')
                self.la26.grid(row=8,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.lla26=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                self.lla26.grid(row=8,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.ea26=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=21)
                ...
                self.b1.grid(row=1,column=2,sticky='W',padx=35,pady=3,ipady=1)
